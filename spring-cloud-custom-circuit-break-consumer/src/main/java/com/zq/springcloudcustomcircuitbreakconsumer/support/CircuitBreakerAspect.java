package com.zq.springcloudcustomcircuitbreakconsumer.support;
...
public class CircuitBreakerAspect {
	...
	private Map<String, AtomicInteger> counter = new ConcurrentHashMap<>(); // 失败次数
	private Map<String, AtomicInteger> breakCounter = new ConcurrentHashMap<>(); // 断路保护次数

	@Around("execution(* com.zq.springcloudcustomcircuitbreakconsumer.integration..*(..))")
